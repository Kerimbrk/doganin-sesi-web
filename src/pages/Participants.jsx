      ...
      <div className="participants-content">
        <section className="glass-panel text-content">
          ...
          <div className="pdf-viewer">
            <iframe 
              src={`${import.meta.env.BASE_URL}nihai_katilimci_listesi.pdf`}
          ...
          <div className="download-section">
            <a href={`${import.meta.env.BASE_URL}nihai_katilimci_listesi.pdf`} target="_blank" rel="noopener noreferrer" className="btn-primary btn-download-large">
              <FileText size={20} />
